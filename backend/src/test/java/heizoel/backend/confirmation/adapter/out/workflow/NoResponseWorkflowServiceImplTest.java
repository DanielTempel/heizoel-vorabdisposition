...
import heizoel.backend.confirmation.adapter.camunda.NoResponseWorkflowServiceImpl;
...
class NoResponseWorkflowServiceImplTest {

    @Mock
    RuntimeService runtimeService;

    @InjectMocks
    NoResponseWorkflowServiceImpl service;
