...
Zwischen der Kundenkommunikation und der Dokumentation in
...
\begin{table}[htbp]
    ...
    \begin{tabularx}{\textwidth}{@{}p{0.10\textwidth}X@{}}
        ...
        A2 &
        Für einen Avisierungsprozess muss eine individuelle
        Rückbestätigungsanfrage mit einem personalisierten
        Kundenlink erzeugt werden. \\

        A3 &
        Die Rückbestätigungsanfrage muss abhängig vom hinterlegten
        ...
        A5 &
        Pro Rückbestätigungsanfrage darf nur eine Kundenreaktion
        statuswirksam verarbeitet werden. Für weitere Reaktionen darf
        ausschließlich die jeweils aktuelle Rückbestätigungsanfrage gültig
        sein. \\

        A6 &
        Das System muss die für eine Rückbestätigungsanfrage
        ...
        Avisierungsprozesse einsehen, durchsuchen und filtern
        können. \\

        A9 &
        Die Auftragsdetailansicht muss die aktuelle
        Rückbestätigungsanfrage, frühere Anfragen und vorhandene
        ...
        und die aktuelle, von DISPO bereitgestellte Fahrzeugposition
        dargestellt werden. \\
        \bottomrule
    \end{tabularx}
\end{table}
...
\begin{table}[htbp]
    ...
    \begin{tabularx}{\textwidth}{@{}p{0.12\textwidth}X@{}}
        ...
        \midrule
        N1 &
        Auftragsdaten, Rückbestätigungsanfragen und
