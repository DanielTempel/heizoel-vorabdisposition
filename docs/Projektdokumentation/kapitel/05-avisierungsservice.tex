...
\texttt{WhatsAppNotificationSender}. Beide Implementierungen
erzeugen aus dem Auftrag und der Rückbestätigungsanfrage einen
gemeinsamen \texttt{ConfirmationMessageContent} und übergeben
...
Auftrags und der Rückbestätigungsanfrage befüllt. Ihre Zuordnung ist
...
\begin{figure}[htbp]
    ...
    \caption{Über Twilio versendete Rückbestätigungsanfragen}
...
\texttt{NotificationDeliveryException} mit Angabe des
...
unterschiedlichen Quellen zusammen. Die aktuelle Fahrerposition
...
Rückbestätigungsanfrage dem jeweiligen Auftrag zu und stellt sie über
...
Die Fahrerposition wird nicht im Avisierungsservice gespeichert,
...
Rückbestätigungsanfrage und dem zugehörigen Auftrag zu. Unbekannte
Token sowie Token inzwischen abgelöster Anfragen können daher
nicht für den Zugriff auf Tracking-Daten verwendet werden.

Die Abfrage der Fahrerposition erfolgt ausschließlich am
...
die DISPO-Schnittstelle und stellt die Fahrerposition als
...
gelieferte Fahrerposition. Die aktuellen Positionsdaten können
...
\texttt{DeliveryAddressCoordinateResolver} diese Adresse in
...
\texttt{DeliveryAddressCoordinateResolver} im aktuellen
...
Rückbestätigungsanfrage und des zugehörigen Auftrags.
...
Die aktuelle Fahrerposition wird über eine getrennte
...
Liefertags, bei einer nicht verfügbaren Fahrerposition und bei
einem fehlgeschlagenen DISPO-Aufruf.

Die Antwort der Tracking-Info-Schnittstelle sowie erfolgreiche
Antworten der Fahrerpositionsschnittstelle werden mit
...
stabil, während die Fahrerposition bei jedem Abruf erneut von
DISPO angefordert wird. Dadurch lässt sich die aktuelle
Fahrerposition wiederholt abfragen, ohne zugleich eine erneute
