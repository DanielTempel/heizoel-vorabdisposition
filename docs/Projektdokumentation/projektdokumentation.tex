...
Benachrichtigung versendet, auf die der Kunde mit einer klar
strukturierten Rückmeldung reagiert.
...
ID & Beschreibung \\
\midrule
A1 & Kunde erhält E-Mail \\
A2 & Kunde bestätigt Lieferfenster \\
A3 & Status wird aktualisiert \\
\bottomrule
\end{tabular}
\end{table}
...
Der größte Aufwand entstand in den Bereichen
Schnittstellenabstimmung, Statuslogik und Integration der
einzelnen Komponenten. Weniger zeitintensiv, aber inhaltlich
wichtig, waren die Abstimmungen mit dem Auftraggeber zur
Absicherung des fachlichen Verständnisses.
...
% =================================================
\section{Nutzenbewertung}
% =================================================

\begin{itemize}
\item Reduzierung manueller Tätigkeiten
\item Schnellere Rückmeldungen
\item Höhere Transparenz
\item Verbesserte Nachverfolgbarkeit
\end{itemize}
