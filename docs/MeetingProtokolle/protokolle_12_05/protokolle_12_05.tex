...
\begin{itemize}[leftmargin=1.2cm]
    ...
    \item Die Stundenaufstellung muss kontinuierlich dokumentiert werden, da dies eine Anforderung der Projektarbeit ist.
\end{itemize}
...
\begin{itemize}[leftmargin=1.2cm]
    \item Weiterentwicklung der API-Endpunkte
