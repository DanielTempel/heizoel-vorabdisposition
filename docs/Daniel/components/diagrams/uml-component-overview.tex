...
\begin{tikzpicture}[
  ...
  \node[external] (dispo) at (3.15,0.7)
    {\textbf{DISPO}\\Planung und Änderung};

  % UML-Notiz: fachlicher Hinweis, keine Komponente
  ...
  \draw[association] (3.15,-3.05) --
    node[edgeLabel,right] {plant Lieferungen}
    (dispo.south);
  \draw[association] (3.60,-4.05) --
    node[edgeLabel,above] {bearbeitet Fälle}
    (dashboard.west);
  \draw[association] (21.0,-4.05) --
    node[edgeLabel,above] {bestätigt, lehnt ab\\oder kommentiert}
    (page.east);
