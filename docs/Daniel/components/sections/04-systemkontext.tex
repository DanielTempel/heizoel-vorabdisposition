...
Disponenten im Dashboard und in DISPO angezeigt.
...
Die Benachrichtigung kann über verschiedene Kommunikationskanäle wie E-Mail, SMS oder
WhatsApp erfolgen. Für das Verständnis des Gesamtablaufs ist nur entscheidend, dass die
Nachricht den persönlichen Link zur Bestätigungsseite enthält.
